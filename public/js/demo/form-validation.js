$(document).ready(function() {
        var a= {
                valid: "fa fa-check-circle fa-lg text-success", invalid: "fa fa-times-circle fa-lg", validating: "fa fa-refresh"
            }
        ;
        $("#demo-password").bootstrapValidator( {
                message:"This value is not valid", feedbackIcons:a, fields: {
                    username: {
                ...
                message:"This value is not valid", feedbackIcons:a, fields: {
                    ...
                    , "programs[]": {
                        validators: {
                            choice: {
                                min: 2, max: 4, message: "Please choose 2 - 4 programming languages you are good at"
                            }
                        }
                    }
                }
                ...
                message:"This value is not valid", feedbackIcons:a, fields: {
                    ...
                    , greaterthan: {
                        validators: {
                            ...
                            , greaterThan: {
                                inclusive: !1, value: 50, message: "Please enter a value greater than 50"
                            }
                        }
                    }
                    , lessthan: {
                        validators: {
                            ...
                            , lessThan: {
                                inclusive: !1, value: 25, message: "Please enter a value less than 25"
                            }
                        }
                    }
                    , range: {
                        validators: {
                            inclusive:!0, notEmpty: {
                                message: "The number is required and can't be empty"
                            }
                            , between: {
                                min: 1, max: 100, message: "Please enter a number between 1 and 100"
                            }
                        }
                    }
                }
                ...
                message:"This value is not valid", feedbackIcons:a, fields: {
                    ...
                    , uppercase: {
                        validators: {
                            ...
                            , stringCase: {
                                message: "The card holder must be in uppercase", case: "upper"
                            }
                        }
                    }
                    , email: {
                    ...
                    , website: {
                        validators: {
                            ...
                            , uri: {
                                allowLocal: !1, message: "The input is not a valid URL"
                            }
                        }
                    }
                    , color: {
                ...
                message:"This value is not valid", excluded:[":disabled"], feedbackIcons:a, fields: {
                    name: {
                        container:"tooltip", validators: {
                            notEmpty: {
                                message: "The first name is required and cannot be empty"
                            }
                            , regexp: {
                                regexp: /^[A-Z\s]+$/i, message: "The first name can only consist of alphabetical characters and spaces"
                            }
                        }
                    }
                    , lastName: {
                        validators: {
                            ...
                            , regexp: {
                                regexp: /^[A-Z\s]+$/i, message: "The last name can only consist of alphabetical characters and spaces"
                            }
                        }
                    }
                    , email: {
                ...
                message:"This value is not valid", excluded:[":disabled"], feedbackIcons:a, fields: {
                    username: {
                        container:"popover", message:"The username is not valid", validators: {
                            notEmpty: {
                ...
                message:"This value is not valid", excluded:[":disabled"], feedbackIcons:a, fields: {
                    phoneNumber: {
                        container:"#demo-error-container", validators: {
                            notEmpty: {
